...
int main(int argc, char* argv[])
{
    ...
    g_unix_signal_add(SIGINT, shutDown, GINT_TO_POINTER(AppShutdown));
    g_unix_signal_add(SIGTERM, shutDown, GINT_TO_POINTER(AppShutdown));

    g_signal_connect(window, "destroy", G_CALLBACK(shutDown), GINT_TO_POINTER(AppShutdown));
